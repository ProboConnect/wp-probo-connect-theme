<?php
/**
 * Hero A — search hero, dark.
 *
 * The hero the theme shipped with, and the only one that follows the
 * Customizer's hero style: dark, accent or light, with the title colour and the
 * overlay derived from that band.
 *
 * @package Probo_Connect
 *
 * @var array  $attributes  Block attributes.
 * @var array  $tokens      Hero tokens for this instance.
 */
